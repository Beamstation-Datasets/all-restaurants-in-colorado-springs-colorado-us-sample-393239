# All Restaurants in Colorado Springs, Colorado, US

> Free BeamStation sample export with 151 rows and masked direct-contact fields.
...
| Full dataset size | 1,518 records |
| Free sample size | 151 records (9.95%) |
| Last export | 2026-04-14T16:57:36.601179+00:00 |
| Download | [Latest release asset](https://github.com/Beamstation-Datasets/all-restaurants-in-colorado-springs-colorado-us-sample-393239/releases/download/sample-latest/beamstation_393239_restaurants-us-co_SAMPLE_DIST.csv) |
...
Search for dataset ID `393239` on BeamStation if you want the exact commercial listing.
